...
public abstract class AbstractMorphologiqueFunction {
	 ...
	 * @throws FieldTrackingAssignementException
	 */
	public void ellipse2DExecute(final String inputFileName, final String outputFileName, final String outputExtention)
			throws IOException, MorphologiqueException, FieldTrackingAssignementException {
		execute(inputFileName, outputFileName, outputExtention,
				new Ellipse2D.Double(MorphMathCorePropertyFile.getInstance().getEllipseX(), MorphMathCorePropertyFile.getInstance().getEllipseY(),
	 ...
	 * @throws FieldTrackingAssignementException
	 */
	protected abstract void execute(String inputFileName, String outputFileName, String outputExtention, Shape shape)
			throws IOException, MorphologiqueException, FieldTrackingAssignementException;
	...
	public String getDefaultNewNameBase() throws FieldTrackingAssignementException {
		if (defaultNewNameBase == null) {
			PropertyServiceProxy.getInstance().getYamlPropertyFile(MorphMathCorePropertyFile.MORPH_CORE_FILE).fieldTraking(this, "defaultNewNameBase");
		}
