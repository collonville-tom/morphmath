...
public class GradientFunction extends AbstractComplexeFunction {
     ...
     * @throws FieldTrackingAssignementException
     */
    public void gradient(final String inputFileName, final String outputFileName, final String outputExtention, final Shape shape) throws IOException, MorphologiqueException,
    FieldTrackingAssignementException {
