...
public abstract class AbstractBasicFunction extends AbstractMorphologiqueFunction {
	 ...
	 */
	protected void imageCheking(final String inputFileName, final String outputFileName, final String outputExtention, final Shape shape)
			throws IOException, MorphologiqueException {
