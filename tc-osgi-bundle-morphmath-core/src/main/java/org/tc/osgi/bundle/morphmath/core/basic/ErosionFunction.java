...
/**
 * ErosionFunction.java.
 * @author collonville thomas
 * @version 0.0.1
 */
public class ErosionFunction extends AbstractBasicFunction {

    /**
     * ErosionFunction constructor.
     */
     ...
     */
    public ErosionFunction(final String _defaultNewNameBase) {
     ...
     */
    public void erosion(final String inputFileName, final String outputFileName, final String outputExtention, final Shape shape) throws IOException, MorphologiqueException {
    ...
    protected void execute(final String inputFileName, final String outputFileName, final String outputExtention, final Shape shape) throws IOException, MorphologiqueException {
    	LoggerServiceProxy.getInstance().getLogger(this.getClass()).debug("erosion");
     ...
     * @param globalY int
     * @return boolean
     * @see org.tc.osgi.bundle.morphmath.basic.AbstractBasicFunction#operation(java.awt.image.BufferedImage, java.awt.geom.Area, int, int)
     */
    @Override
